...
<table  cellpadding=10 width=100% cellspacing=0>  
	<tr> 
			...
			<td><?=$description ?></td>
			 <td><?=$prix." Euros" ?></td>
			 <td><div class="btn-co-produits" style="background: #0b5ed7"><a href="index.php?uc=gererProduits&etatGestion=ajouterProduit&idProduit=<?=$id ?>">Ajouter</a><div>
